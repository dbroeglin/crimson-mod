package fr.broeglin.ael.mods.crimson.items;
...
public class StarcraftEntity extends EntityThrowable
{
    public StarcraftEntity(World worldIn)
    {
        super(worldIn);
    }

    public StarcraftEntity(World worldIn, EntityLivingBase throwerIn)
    {
        super(worldIn, throwerIn);
    }

    public StarcraftEntity(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    {
        CrimsonMod.logger.debug("onImpact...");
